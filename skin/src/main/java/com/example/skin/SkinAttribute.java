    ...
    public void look(View view, AttributeSet attrs) {
        ...
        for (int i = 0; i < attrs.getAttributeCount(); i++) {
            ...
            if (mAttributes.contains(attributeName)) {
                ...
                System.out.println("attributeName,resId"+attributeName+" "+resId+" "+view.getId()+view.getClass().getName());
                ...
                switch (skinPair.attributeName) {
                    case "background":
                        ...
                        if (background instanceof Integer) {
                            ...
                            System.out.println("single change"+background.getClass().getName());
                    ...
                    case "src":
                        ...
                        break;
                    case "textColor":
                        System.out.println("text"+SkinResources.getInstance().getColorStateList
                                (skinPair.resId));
